...
class ViConsformerEncoder(T5Stack):
    def __init__(
        ...
        super(ViConsformerEncoder, self).init()
    ...
    def forward(
        ...
        ocr_tokens_inputs       = self.tokenize(list_ocr_tokens_string, max_length=self.ocr_config["num_ocr"])
